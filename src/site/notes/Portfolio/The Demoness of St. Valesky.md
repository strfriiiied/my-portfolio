...
## Interaction Design
I put a lot of work into the UI and how it feels to use. I made a ton of use of Unity’s animation system in all UI interactions. A big focus for me was to make sure that each menu felt like it should flow naturally into the next one.

# What Didn't Work
## Scope & Unique Development Difficulties
